export const ru = {
  ...
  nav: {
    ...
    showFewer: "Свернуть",
    manageSections: "Настроить разделы",
    aiNeedsSetup: "Настроить",
  },
  ...
  aiAnalysis: {
    ...
    empty: "Спросите о своей карте или расскажите о лекарстве, диагнозе, симптоме либо измерении.",
    starter1: "Что говорят мои последние анализы?",
    starter2: "Какие показатели вне нормы и почему это важно?",
    starter3: "Есть ли взаимодействия между моими лекарствами?",
    placeholder: "Спросите о своём здоровье…",
    inputHint:
      "Enter — отправить, Shift+Enter — новая строка. Не является медицинской консультацией.",
    attachDocument: "Импортировать медицинский документ",
    importDocument: "Импорт",
    thinking: "Думаю…",
    retry: "Повторить",
    stop: "Остановить",
    clear: "Очистить чат",
    clearConfirmTitle: "Очистить чат?",
    clearConfirmBody:
      "Переписка уйдёт в архив, ассистент начнёт с чистого листа. Записи, уже сохранённые в медицинскую карту, не затрагиваются.",
    jumpToLatest: "К последнему",
    regenerate: "Переспросить",
    copied: "Скопировано",
    viewContext: "Что видит ассистент",
    contextExplainer:
      "Эта safety-сводка отправляется с каждым вопросом. Остальные записи ассистент извлекает только при необходимости. Имя не передаётся.",
    changes: {
      saved: "Сохранено в медицинскую карту",
      itemCount: "записей: {{count}}",
      showDetails: "Подробности",
      hideDetails: "Свернуть",
      discarded: "Черновик удалён",
      review: "Ничего не сохранится, пока вы не проверите и не подтвердите",
      saving: "Сохраняю…",
      save: "Сохранить выбранное ({{count}})",
      discard: "Удалить черновик",
      blocked: "Исключите заблокированные пункты или уточните недостающие данные в чате.",
      matches: "Найдены похожие записи",
      openRecord: "Открыть запись",
      risk: {
        standard: "Обычная запись",
        elevated: "Медицинская карта",
      ...
      field: {
        ...
        emergencyNotes: "Заметки для экстренных случаев",
        ...
        heightCm: "Рост",
        icdCode: "Код МКБ",
        intervalMonths: "Интервал (мес.)",
        items: "Позиции",
        label: "Название",
        languages: "Языки",
        lastTestedDate: "Последняя сдача",
        manufacturer: "Производитель",
        medicationType: "Тип препарата",
        modalityType: "Модальность",
        name: "Название",
        notes: "Заметки",
        onsetDate: "Начало",
        originalText: "Исходный текст",
        position: "Положение",
        pregnancyStatus: "Беременность",
        purpose: "Назначение",
        radiologistName: "Рентгенолог",
        reaction: "Реакция",
        resolvedDate: "Разрешилось",
        restingHeartRate: "Пульс покоя",
        rhFactor: "Резус-фактор",
        scheduleNotes: "Заметки к расписанию",
        severity: "Тяжесть",
        sex: "Пол",
        ...
        times: "Время приёма",
        title: "Заголовок",
        trainingIntensity: "Интенсивность тренировки",
        trainingMinutes: "Тренировка (минут)",
        vaccineName: "Вакцина",
        weightKg: "Вес",
        text: "Текст",
        value: "Значение",
      ...
      entity: {
        ...
        vaccine: "Прививка",
        retest_schedule: "Напоминание об анализе",
        profile: "Профиль",
      },
    },
  },
  aiInterpretation: {
    title: "AI-интерпретация тренда",
    prompt: "Краткое объяснение этого тренда с учётом ваших лекарств и диапазонов.",
    button: "Объяснить тренд",
    loading: "Анализирую…",
    retry: "Повторить",
    regenerate: "Сгенерировать заново",
    cached: "Сохранено с прошлого запуска",
    errorAuth: "Ключ API отклонён. Проверьте настройки AI.",
  ...
  errors: {
    ...
    pageBody:
      "При загрузке данных произошла ошибка. Подробности записаны в файл журнала (Настройки → Открыть журнал).",
    retry: "Повторить",
  ...
  common: {
    ...
    validation: {
      ...
      resolvedBeforeStart: "Дата разрешения не может быть раньше даты диагноза.",
      expiryBeforeDose: "Срок действия не может быть раньше даты постановки.",
      futureBirthDate: "Дата рождения не может быть в будущем.",
      bpOrder: "Систолическое должно быть выше диастолического — проверьте значения.",
    },
  },
  ...
  // Common field labels
  placeholders: {
    diagnosisName: "например, субклинический гипотиреоз",
    specialty: "эндокринолог…",
    drugExample: "например, витамин D3",
    doseUnit: "МЕ",
    frequency: "ежедневно",
    prescriptionNotes: "например, 3 месяца, потом пересдать 25-OH",
    labName: "например, Инвитро",
    allergen: "например, пенициллин, арахис",
    reaction: "например, крапивница, отёк, анафилаксия",
    notes: "Дополнительные заметки",
    vaccineName: "например, COVID-19, грипп",
    manufacturer: "например, Pfizer",
    lotNumber: "например, EK5730",
    country: "например, Германия",
    clinic: "например, городская клиника",
    medicationName: "например, магния глицинат",
    medicationDoseUnit: "мг / МЕ / г",
    schedule: "с едой, перед сном, 5 через 2…",
    purpose: "качество сна, ферритин…",
  },
  ...
  fields: {
    ...
    cost: "Стоимость",
    costHint: "Сколько заплатили за весь чек-ап (USD).",
    notes: "Заметки",
    unit: "Единица",
    value: "Значение",
  },
  ...
  settings: {
    sections: {
      ...
      description: "Выберите, какие разделы показывать в боковом меню.",
    },
    dashboard: {
      title: "Главный экран",
      description:
        "Выберите, какие карточки показывать на главном экране. Скрытые карточки остаются доступны из меню — меняется только дашборд.",
      widgets: {
        safetyBanner: {
          label: "Баннер критических аллергий",
          desc: "Красная полоса с предупреждением о тяжёлых и опасных для жизни аллергиях.",
        },
        verdict: {
          label: "Сводный статус",
          desc: "Строка «всё спокойно» / «нужно внимание».",
        },
        stats: {
          label: "Краткая статистика",
          desc: "Анализы, показатели вне нормы, активные препараты и последний забор.",
        },
        attention: {
          label: "Требует внимания",
          desc: "Сводка по биомаркерам, диагнозам, препаратам и прививкам.",
        },
        review: {
          label: "Очередь на проверку",
          desc: "Импортированные анализы, которые ждут вашего подтверждения.",
        },
        changes: {
          label: "Заметные изменения",
          desc: "Что изменилось с прошлой панели анализов.",
        },
        activity: {
          label: "Недавняя активность",
          desc: "Последние записи: анализы, препараты, диагнозы и другое.",
        },
      },
      safetyConfirm: {
        title: "Скрыть баннер критических аллергий?",
        body: "Этот баннер сразу предупреждает о тяжёлых, опасных для жизни аллергиях. Он останется на карте экстренной помощи, но больше не будет показываться на главном экране.",
        confirm: "Скрыть",
      },
    },
    reset: {
      title: "Сбросить персонализацию",
      description:
        "Вернуть все разделы меню и карточки дашборда, включить все уведомления и восстановить скрытые напоминания и подсказки. Ваши медицинские данные не затрагиваются.",
      action: "Сбросить персонализацию",
      done: "Персонализация сброшена к настройкам по умолчанию.",
      confirm: {
        title: "Сбросить персонализацию?",
        body: "Разделы меню, карточки дашборда, настройки уведомлений и скрытые напоминания и подсказки вернутся к значениям по умолчанию. Это не затронет ваши записи.",
      },
    },
    appearance: {
      title: "Внешний вид",
    ...
    updates: {
      title: "Обновления",
      description: "Установленная версия: v{{version}}",
      loadingVersion: "Определяем установленную версию…",
      checking: "Проверяем GitHub Releases…",
      check: "Проверить снова",
      available: "Доступна Soma v{{version}}.",
      current: "У вас актуальная версия. Последний релиз: v{{version}}.",
      noReleases: "Опубликованных релизов пока нет.",
      error: "Не удалось проверить GitHub Releases. Проверьте соединение и повторите попытку.",
      newVersion: "Новая версия",
      openRelease: "Открыть v{{version}}",
      allReleases: "Все релизы",
      manual: "Обновления скачиваются с GitHub и устанавливаются вручную.",
    },
    logs: {
      title: "Логи",
    ...
    mcp: {
      ...
      writesTitle: "Разрешить запись",
      writesDesc:
        "Позволяет ассистенту не только читать, но и добавлять записи (лекарства, анализы, симптомы…). Применяется ко всем ассистентам ниже и вступает в силу после их перезапуска.",
      readWrite: "чтение + запись",
      readOnly: "только чтение",
      writesConfirm: {
        title: "Разрешить ассистенту записывать данные о здоровье?",
        body: "Если включить, любой подключённый выше ассистент сможет добавлять и изменять записи в Soma — лекарства, диагнозы, прививки, заметки и другое — а не только читать их. В любой момент можно выключить на этом же экране.",
        confirm: "Разрешить запись",
      },
    },
    title: "Настройки",
    description:
    ...
    export: {
      ...
      error: "Не удалось экспортировать: {{message}}",
    },
  },
  ...
  onboarding: {
    ...
    welcomeDescription:
      "Ваша медицинская карта на ваших условиях — анализы, лекарства и визиты в одной приватной временной шкале. Минута настройки позволит Soma оценивать ваши результаты по тому, что считается нормой именно для вас.",
    privacyNote:
    ...
    aboutYouTitle: "О вас",
    aboutYouDescription:
      "Soma использует ваш пол и возраст, чтобы понимать, какие результаты для вас в норме — только поэтому эти поля обязательны.",
    ...
    disclaimer:
      "Soma организует ваши записи — это не медицинское устройство и не даёт медицинских советов.",
    restore: "У меня уже есть бэкап",
    interestsTitle: "Что вы хотите отслеживать?",
    interestsDescription:
      "Выберите интересующие разделы. Остальные не будут показываться в меню — включить их можно в любой момент в настройках.",
    interestsHint: "Анализы, биомаркеры и шкала всегда включены.",
    groups: {
      meds: { label: "Лекарства и добавки", desc: "Дозы, расписание, периоды приёма" },
      conditions: { label: "Визиты и диагнозы", desc: "Визиты к врачу, диагнозы, рецепты" },
      allergies: { label: "Аллергии и неотложная карта", desc: "Записи об аллергиях и карта" },
  ...
  gettingStarted: {
    title: "С чего начать",
    description: "Несколько шагов, чтобы Soma стала полезной.",
    importLab: "Импортируйте или добавьте первый анализ",
    addMed: "Добавьте лекарство или добавку",
    enableAi: "Включите AI-импорт и ассистента (по желанию)",
    cta: "Открыть",
    skip: "Пропустить настройку",
  },

  hints: {
    overlayTitle: "Совет: наложите лекарства на график",
    overlayBody:
      "Включите любое лекарство ниже, чтобы увидеть период приёма полосой поверх тренда — и понять, влияет ли то, что вы принимаете, на показатель.",
  },
  ...
  // Сравнение двух панелей анализов
  labCompare: {
    title: "Сравнить даты анализов",
    description: "Две панели рядом и что изменилось между ними.",
    button: "Сравнить",
    panelA: "Первая панель",
    panelB: "Вторая панель",
    selectPrompt: "Выберите две панели для сравнения.",
    samePanel: "Выберите две разные панели.",
    needTwoPanels: "Нужно минимум две панели анализов для сравнения.",
    columns: {
      biomarker: "Биомаркер",
      change: "Изменение",
      status: "Статус",
  ...
  labs: {
    ...
    findingsTitle: "Дополнительные находки",
    findingsDescription:
      "Результаты, сохранённые без биомаркера (несопоставленные или качественные), сгруппированные по всем панелям. Нажмите на строку, чтобы открыть панель.",
    tableColumns: {
      date: "Дата",
      lab: "Лаборатория",
      ...
      source: "Источник",
      finding: "Показатель / исходная метка",
    },
    importSource: {
      ai: "ИИ",
      manual: "вручную",
  ...
  timeline: {
    ...
    scrollHint: "Прокручивайте горизонтально, чтобы посмотреть всю историю.",
    scrollAreaLabel: "Прокручиваемая временная шкала здоровья",
    legend: {
      title: "Легенда",
  ...
  labPanelDetail: {
    ...
    findingsTitle: "Дополнительные находки",
    findingsDescription:
      "Результаты, сохранённые без биомаркера (несопоставленные или качественные). Редактируются, в трендах не участвуют.",
    editFindingTitle: "Редактировать находку",
    editResultTitle: "Редактировать результат",
    editResultDescription:
      "Исправьте значение или его единицу. Нормализация и флаги пересчитываются; при нераспознанной единице значение сохраняется как есть, без флагов.",
    resultUpdatedToast: "Результат обновлён.",
    editPanel: "Редактировать панель",
    editPanelTitle: "Редактировать панель",
    editPanelDescription: "Исправьте дату, лабораторию и контекст панели. Результаты не меняются.",
    panelUpdatedToast: "Панель обновлена.",
    panelNotFound: "Панель не найдена",
    noResults: "В этой панели нет числовых результатов.",
    findingsOnly: "В панели только качественные находки — тренды не строятся.",
    tableColumns: {
      biomarker: "Биомаркер",
      value: "Значение",
      change: "Δ к прошлому",
  ...
  vaccines: {
    ...
    calendar: {
      ...
      addBirthDate:
        "Укажите дату рождения в профиле, чтобы видеть персональные статусы «пора / требует действия».",
      summaryClear: "Сейчас ничего не требует действий.",
      actionable: "требует действия: {{n}}",
      due: "предстоит: {{n}}",
      doseN: "Доза {{n}}",
      next: "след. {{date}}",
      ...
      status: {
        ...
        not_recorded: "Не отмечено",
      },
      tiers: {
        universal: "Детская серия",
      ...
      tierBlurbs: {
        universal:
          "Обычно завершается в детстве. Отметьте или импортируйте, если делали — неотмеченные не считаются просроченными.",
        special: "Часто добавляют в зависимости от страны и истории прививок.",
        regional: "Актуально для путешествий — справочно, зависит от региона поездки.",
        risk: "Актуально для путешествий — справочно, зависит от направления и контакта.",
      },
    },
  },
  ...
  keychain: {
    unavailableTitle: "Системное хранилище ключей недоступно",
    unavailableLinux:
      "Soma хранит API-ключи и пароль от резервных копий в Linux Secret Service — ничего секретного не пишется на диск в открытом виде. Сейчас ни одно хранилище ключей не отвечает. Установите и запустите его (например, gnome-keyring или KWallet) и нажмите «Проверить снова». Всё остальное в Soma работает и без него.",
    unavailableGeneric:
      "Soma не смогла обратиться к системному хранилищу ключей ({{backend}}). Убедитесь, что оно доступно, и нажмите «Проверить снова».",
    recheck: "Проверить снова",
    saveFailed:
      "Не удалось сохранить в системное хранилище. Смотрите уведомление выше и нажмите «Проверить снова».",
  },
  ...
  trendChart: {
    ...
    pointsHidden: "Скрыто точек: {{count}} — единица измерения не относится к этой шкале.",
  ...
  importWizard: {
    ...
    aiSuggestionBadge: "черновик ИИ",
    saveToFindings: "Сохранить в находки",
    findingsTitle: "Дополнительные находки",
    findingsDescription:
      "Нечисловые результаты из отчёта (например, «отрицательно», титры). Сохраняются с панелью как есть — как биомаркеры не отслеживаются. Отредактируйте или удалите строки перед сохранением.",
    swapDuplicateHint: "Использовать этот результат вместо выбранного",
    aiSuggestionHint:
      "Диалог предзаполнен черновиком определения биомаркера от ИИ на основе напечатанной метки, единицы и референсного диапазона — проверьте каждое поле перед созданием.",
    translatedHint:
    ...
    privacyNotice:
      "Выбранный документ полностью отправляется выбранному вами ИИ-провайдеру для распознавания. Все остальные данные остаются на вашем устройстве.",
    ...
    duplicateGroupHint:
      "Две строки сопоставлены с одним биомаркером. По умолчанию оставлено лучшее совпадение — при необходимости выберите другое.",
    duplicatesUnresolved:
      "У {{count}} биомаркера(ов) выбрано несколько строк-дубликатов — оставьте по одной.",
    ...
    docTypes: {
      ...
      dischargeDescription: "Визит, диагнозы, лекарства и аллергии.",
      imaging: "Заключение по снимкам",
      imagingDescription: "Лучевые исследования — рентген, КТ, МРТ, УЗИ — и их описание.",
      prescription: "Рецепт",
      prescriptionDescription: "Назначенные препараты и добавки с дозой и режимом приёма.",
      allergy: "Запись об аллергиях",
      allergyDescription: "Аллергии и непереносимости с реакцией и тяжестью.",
    },
    choosePrompt: "Выберите: {{type}}",
    extractingDoc: "Читаем документ…",
    verifyBadge: "проверить",
    reviewBanner: {
    ...
    vaccineReview: {
      ...
      description:
        "Каждая доза сопоставлена с вакциной из вашего календаря — подтвердите сопоставление, отметьте нужные дозы и при необходимости исправьте поля по оригиналу.",
      saving: "Сохраняем прививки…",
      selectAll: "Выбрать все",
      noMatch: "Нет совпадения",
      columns: {
        vaccine: "Как в документе",
        match: "Вакцина из календаря",
        dose: "Доза №",
        manufacturer: "Производитель",
        batch: "Серия",
    ...
    dischargeReview: {
      ...
      allergyBadge: "аллергия",
      empty: "В документе не найдено диагнозов, лекарств или аллергий.",
      save: "Сохранить записей: {{count}}",
    },
    imagingReview: {
      title: "Проверьте исследования",
      description: "Отметьте исследования для сохранения и исправьте поля по заключению.",
      empty: "В документе не найдено лучевых исследований.",
      columns: {
        date: "Дата",
      ...
      save: "Сохранить исследований: {{count}}",
    },
    prescriptionReview: {
      title: "Проверьте назначенные лекарства",
      description: "Отметьте лекарства для сохранения и исправьте дозу, тип и режим приёма.",
      empty: "В документе не найдено лекарств.",
      columns: {
        name: "Лекарство",
        type: "Тип",
        dose: "Доза",
        schedule: "Режим приёма",
        purpose: "Назначение",
      },
      duplicate: "уже отслеживается",
      duplicateHint: "Лекарство с таким названием уже есть в вашем списке.",
      save: "Сохранить лекарств: {{count}}",
    },
    allergyReview: {
      title: "Проверьте аллергии",
      description: "Отметьте аллергии для сохранения и подтвердите категорию и тяжесть.",
      empty: "В документе не найдено аллергий.",
      columns: {
        allergen: "Аллерген",
        category: "Категория",
        severity: "Тяжесть",
      ...
      duplicateHint: "Аллергия на этот аллерген уже записана.",
      save: "Сохранить аллергий: {{count}}",
    },
  },

  // Связь с исходным документом, из которого был импорт
  sourceFile: {
    title: "Исходный документ",
    attached: "Файл-источник",
    open: "Открыть оригинал",
    openInApp: "Посмотреть оригинал",
    openExternally: "Открыть в системе",
    revealInFinder: "Показать в папке",
    page: "Стр. {{n}}",
    fromPage: "со стр. {{n}}",
    none: "Нет файла-источника",
    manualEntry: "Введено вручную — исходного документа нет.",
    missing: "Не удалось найти исходный файл. Возможно, он перемещён или удалён.",
    previewUnsupported: "Для этого типа файла встроенный просмотр недоступен.",
    pdf: "PDF-документ",
    image: "Изображение",
    close: "Закрыть",
  ...
  // Постоянное состояние «требует проверки» для неуверенных ИИ-сопоставлений
  needsReview: {
    badge: "на проверку: {{count}}",
    one: "1 результат требует проверки",
    many: "Результатов на проверку: {{count}}",
    panelTitle: "Часть результатов требует вашей проверки",
    panelDescription:
      "Эти сопоставления были неуверенными — откройте оригинал, сверьте каждое значение и подтвердите.",
    rowHint: "Неуверенно — сверьте с источником",
    confirm: "Подтвердить",
    confirmRow: "Подтвердить сопоставление",
    confirmAll: "Подтвердить все",
    reviewed: "Проверено",
    allReviewed: "Все результаты проверены",
    verifyAction: "Проверить и подтвердить",
    globalTitle: "Импорты, ожидающие проверки",
    globalOne: "1 импорт с непроверенными результатами",
    globalMany: "Импортов с непроверенными результатами: {{count}}",
    globalCta: "Проверить",
    confirmedToast: "Отмечено как проверенное",
  },

  // Экран сверки «документ ⟷ извлечённые значения»
  verify: {
    title: "Сверка импорта",
    description: "Сверьте каждое извлечённое значение с оригиналом документа.",
    sourcePane: "Оригинал документа",
    resultsPane: "Извлечённые результаты",
    onlyUncertain: "Только строки на проверку",
    showAll: "Показать все строки",
    confirm: "Подтвердить",
    confirmAll: "Подтвердить оставшиеся",
    edit: "Изменить сопоставление",
    done: "Готово",
    backToPanel: "К панели",
    empty: "Проверять больше нечего.",
    jumpToPage: "Перейти на стр. {{n}}",
  },

  // Типизированные ошибки ИИ-импорта (вместо одного общего баннера)
  importErrors: {
    authTitle: "Ключ API отклонён",
    authBody: "Провайдер ИИ отклонил ключ. Проверьте его в настройках.",
    authAction: "Открыть настройки",
    rateLimited: "Провайдер ограничивает частоту запросов.",
    overloaded: "Провайдер ИИ перегружен.",
    retrying: "Временная ошибка — повтор ({{attempt}}/{{max}})…",
    network: "Не удалось связаться с провайдером ИИ. Проверьте соединение.",
    retry: "Повторить",
    badDocumentTitle: "Результаты не найдены",
    badDocumentBody:
      "Не удалось найти значения в этом файле. Тот ли это тип документа и читается ли скан?",
    switchType: "Сменить тип документа",
    truncatedTitle: "Документ, возможно, слишком большой",
    truncatedBody:
      "Ответ был обрезан, часть результатов может отсутствовать. Проверьте внимательно или разделите файл.",
    parseFailed: "ИИ вернул нечитаемый ответ. Попробуйте ещё раз.",
    tooLarge:
      "Документ слишком большой для ИИ-провайдера. Разделите PDF или импортируйте меньше страниц за раз.",
    fileTooLarge:
      "Этот файл больше {{limit}} МБ — слишком велик для отправки ИИ-провайдеру. Разделите PDF или используйте скан меньшего размера.",
    badRequest:
      "ИИ-провайдер отклонил запрос. Выбранная модель может не поддерживать PDF или изображения — выберите модель с поддержкой изображений в настройках.",
    droppedRows:
      "Пропущено нечисловых строк: {{count}} (например, положительно/отрицательно, титры).",
    showDropped: "Показать пропущенные строки",
    dateNotRecognized: "Не удалось распознать дату забора — поставлена сегодняшняя. Укажите её.",
    truncated:
      "Ответ ИИ упёрся в лимит длины и оборвался — строки после обрыва не попали сюда. Сверьтесь с документом и добавьте недостающее вручную.",
    genericTitle: "Импорт не удался",
  },
  ...
  dashboard: {
    ...
    importLab: "Импортировать анализ",
    empty: {
      title: "Главный экран скрыт",
      description:
        "Вы отключили все карточки дашборда. Включите хотя бы одну, чтобы заполнить экран.",
      cta: "Выбрать карточки",
    },
    stats: {
  ...
  journal: {
    ...
    overview: {
      ...
      emptyDescription: "Записывайте вес, давление или симптомы — здесь они появятся вместе.",
      entries: "записей: {{n}}",
      pulse: "пульс {{n}}",
      ranges: {
        "3m": "3 мес",
  ...
  // Контекст образа жизни (сон / тренировки / стресс) — обогащение для ИИ v0.3
  lifestyle: {
    title: "Образ жизни",
    description:
      "Ежедневный сон, тренировки и стресс — контекст, который делает ваши тренды и ИИ-анализ точнее.",
    ...
    metrics: {
      ...
      avgSleepQuality: "Качество сна",
      trainingLoad: "Тренировки",
      trainingDays: "{{count}} дн.",
    ...
    fields: {
      ...
      sleepHours: "Сон (часы)",
      sleepQuality: "Качество сна",
      trainingMinutes: "Тренировки (минуты)",
      trainingIntensity: "Интенсивность",
      steps: "Шаги",
      restingHeartRate: "Пульс покоя",
      stressLevel: "Уровень стресса",
      energyLevel: "Уровень энергии",
    ...
    dialog: {
      titleAdd: "Записать день образа жизни",
      titleEdit: "Изменить день образа жизни",
    },
    integrations: {
      title: "Подключённые источники",
      comingSoon: "Скоро",
      body: "Синхронизация с Apple Health, Google Fit и Health Connect в планах. Пока вводите сон, тренировки и стресс вручную — модель данных уже подготовлена под будущую автоматическую синхронизацию.",
      docNote: "Описание интеграции см. в docs/health-data-integrations.md.",
    },
  },

  // Лента уведомлений (только внутри приложения — никогда не системные уведомления)
  notifications: {
    title: "Уведомления",
    description:
      "Напоминания о приёме лекарств и запланированные повторные анализы — только внутри приложения, ничего не покидает ваше устройство.",
    emptyTitle: "Всё под контролем",
    emptyDescription:
      "Напоминания о лекарствах и повторные анализы, которые пора сдать, появятся здесь.",
    feedTitle: "Лента",
    prefs: {
      title: "О чём вас уведомлять",
      description:
        "Отключите категории, которые вам не нужны. Действует на ленту и счётчик у колокольчика.",
      medication: {
        label: "Напоминания о лекарствах",
        desc: "Ежедневное напоминание о постоянных препаратах, которые вы ещё не отметили.",
      },
      retest: {
        label: "Напоминания о повторных анализах",
        desc: "Сигнал, когда пора пересдать запланированный показатель или панель.",
      },
      retestUpcoming: {
        label: "Показывать предстоящие",
        desc: "Показывать и анализы, которые скоро пора сдать — отключите, чтобы видеть только наступившие и просроченные.",
      },
    },
    dismiss: "Скрыть",
    dismissed: "Скрыто",
    showDismissed: "Показать скрытые ({{count}})",
    hideDismissed: "Скрыть скрытые",
    restore: "Вернуть",
    medication: {
      title: "Примите {{name}}",
      due: "Запланировано на сегодня — ещё не отмечено",
      atTimes: "В {{times}}",
      open: "Лекарства",
    },
    retest: {
      title: "Повторный анализ: {{label}}",
      dueToday: "Пора сдать сегодня",
      due: "Пора сдать {{date}}",
      overdue: "Просрочено на {{days}} дн.",
      upcoming: "Сдать через {{days}} дн.",
      noAnchor: "Укажите дату последнего анализа, чтобы запустить цикл",
      open: "Открыть",
    },
    schedules: {
      title: "Графики повторного тестирования",
      description:
        "Задайте цикл, чтобы напоминать о повторной проверке показателя раз в несколько месяцев.",
      add: "Добавить график",
      emptyTitle: "Графиков повторных анализов нет",
      emptyDescription:
        "Добавьте показатель или панель, которые хотите перепроверять с регулярным циклом.",
      every: "Каждые {{n}} мес.",
      nextDue: "Следующий срок",
      lastTested: "Последний анализ",
      status: "Статус",
      active: "Активен",
      paused: "На паузе",
      pause: "Пауза",
      ...
      dialog: {
        titleAdd: "Добавить график повторного анализа",
        titleEdit: "Изменить график повторного анализа",
      },
      fields: {
        label: "Метка",
        labelPlaceholder: "напр. Липидный профиль, Витамин D, ТТГ",
        biomarker: "Связанный биомаркер (необязательно)",
        biomarkerNone: "Нет",
        intervalMonths: "Повторять каждые (месяцы)",
        lastTestedDate: "Последний анализ (необязательно)",
        notesOptional: "Заметки (необязательно)",
      },
    },
  },

  // Отчёт для врача (генератор PDF)
  doctorReport: {
    title: "Отчёт для врача",
    description: "Сформируйте аккуратную PDF-сводку вашей карты, чтобы поделиться с врачом.",
    intro:
      "Печатная сводка ваших текущих проблем, лекарств, аллергий и недавних результатов. Создаётся локально на вашем устройстве — ничего не загружается в сеть.",
    generate: "Сформировать PDF",
    generating: "Формируем…",
    rangeLabel: "Период истории",
    range: {
    ...
    from: "С",
    to: "По",
    sectionsLabel: "Включить разделы",
    sections: {
      diagnoses: "Диагнозы",
      medications: "Лекарства",
      allergies: "Аллергии",
    ...
    pdf: {
      title: "Сводка о здоровье",
      preparedFor: "Подготовлено для {{name}}",
      generatedOn: "Сформировано {{date}}",
      rangeAll: "Полная история",
      rangeFromTo: "{{from}} – {{to}}",
      rangeUpTo: "До {{to}}",
      rangeFrom: "С {{from}}",
      ...
      abnormal: {
        heading: "Показатели вне нормы (последние)",
      },
      labs: {
        heading: "Анализы",
        panel: "{{name}} · {{date}}",
        panelNoName: "Панель анализов · {{date}}",
        marker: "Показатель",
        value: "Значение",
        reference: "Референс",
      ...
      lifestyle: {
        heading: "Контекст образа жизни",
        summary: "Средние за {{count}} записанных дней",
        sleep: "Сон {{n}} ч",
        sleepQuality: "Качество сна {{n}}/5",
        training: "Тренировки всего {{n}} мин",
        stress: "Стресс {{n}}/5",
        energy: "Энергия {{n}}/5",
        restingHr: "Пульс покоя {{n}} уд/мин",
      },
      flags: {
        low: "низкое",
        high: "высокое",
      ...
      disclaimer:
        "Сформировано в Soma из самостоятельно введённых данных. Это личная сводка, а не официальный медицинский документ и не медицинская консультация. Сверяйте с исходными документами.",
    },
  },

  // Шифрование базы данных в покое (опционально)
  dbEncryption: {
    title: "Шифрование базы данных",
    description: "Шифруйте локальную базу данных в покое. Опционально, по умолчанию выключено.",
    statusOff: "Выкл.",
    statusOn: "Вкл.",
    on: "Шифрование включено",
    off: "Ваша база данных не зашифрована в покое.",
    howItWorks:
      "Когда включено, Soma хранит базу данных зашифрованной на диске (Argon2id + AES-256-GCM), пока приложение закрыто, и расшифровывает её при запуске. Данные находятся в открытом виде только во время работы приложения.",
    modeLabel: "Режим разблокировки",
    modeKeychain: "Автоматически (хранилище ключей ОС)",
    modeKeychainDesc:
      "Ключ хранится в хранилище ключей ОС; Soma разблокируется автоматически при запуске. Защищает от офлайн-кражи диска. Минимум трений.",
    modePassphrase: "Парольная фраза при запуске",
    modePassphraseDesc:
      "Вы вводите парольную фразу при каждом запуске; ключ никогда не пишется на диск. Самый надёжный режим — устойчив к компрометации хранилища ключей.",
    passphrase: "Парольная фраза",
    passphraseConfirm: "Подтвердите парольную фразу",
    passphraseHint: "Минимум 8 символов. Если вы её забудете, восстановить будет невозможно.",
    enable: "Включить шифрование",
    disable: "Выключить шифрование",
    enabling: "Включаем…",
    disabling: "Выключаем…",
    changeMode: "Сменить режим",
    warning:
      "Если вы забудете парольную фразу, ваши зашифрованные данные невозможно будет восстановить — никем, включая разработчиков Soma.",
    mismatch: "Парольные фразы не совпадают.",
    tooShort: "Парольная фраза должна быть не короче 8 символов.",
    enabledToast: "Шифрование базы данных включено",
    disabledToast: "Шифрование базы данных выключено",
    modeChangedToast: "Режим разблокировки обновлён",
    error: "Не удалось изменить настройки шифрования",
    requiresKeychainNote:
      "Шифрование хранит свой ключ в хранилище ключей ОС, поэтому требуется рабочее хранилище ключей.",
  },

  // Экран разблокировки (режим парольной фразы, показывается до загрузки приложения)
  unlock: {
    title: "Разблокировать Soma",
    description: "Введите парольную фразу базы данных, чтобы расшифровать данные о здоровье.",
    passphrase: "Парольная фраза",
    unlock: "Разблокировать",
    unlocking: "Разблокируем…",
    wrong: "Неверная парольная фраза — попробуйте ещё раз.",
    error: "Не удалось разблокировать базу данных.",
    forgot:
      "Забыли её? Зашифрованные данные нельзя восстановить без парольной фразы. Вы можете восстановиться из незашифрованной резервной копии или начать заново.",
  },
} as const;
