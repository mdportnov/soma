export const en = {
  ...
  aiAnalysis: {
    ...
    empty:
      "Ask about your record, or tell Soma about a medication, diagnosis, symptom or measurement.",
    ...
    attachDocument: "Import a health document",
    ...
    clearConfirmBody:
      "The conversation is archived and the assistant starts fresh. Records already saved to your health record are not affected.",
    ...
    changes: {
      ...
      review: "Nothing is saved until you review and confirm",
      saving: "Saving…",
      save: "Save selected ({{count}})",
      discard: "Discard draft",
      blocked: "Exclude blocked items or clarify the missing information in chat.",
      matches: "Existing matches",
      openRecord: "Open record",
      risk: {
        standard: "Standard",
        elevated: "Health record",
      ...
      entity: {
        ...
        imaging: "Imaging",
        vaccine: "Vaccine",
        retest_schedule: "Retest reminder",
        profile: "Profile",
      },
    },
  },
  ...
  placeholders: {
    diagnosisName: "e.g. Subclinical hypothyroidism",
    specialty: "endocrinologist…",
    drugExample: "e.g. Vitamin D3",
    doseUnit: "IU",
    frequency: "daily",
    prescriptionNotes: "e.g. for 3 months, retest 25-OH after",
    labName: "e.g. Invitro",
    allergen: "e.g. Penicillin, Peanuts",
    reaction: "e.g. Hives, swelling, anaphylaxis",
    notes: "Additional notes",
    vaccineName: "e.g. COVID-19, Influenza",
    manufacturer: "e.g. Pfizer",
    lotNumber: "e.g. EK5730",
    country: "e.g. Germany",
    clinic: "e.g. City clinic",
    medicationName: "e.g. Magnesium glycinate",
    medicationDoseUnit: "mg / IU / g",
    schedule: "with food, before sleep, 5 on / 2 off…",
    purpose: "sleep quality, ferritin…",
  },
  ...
  labPanelDetail: {
    ...
    editResultDescription:
      "Correct the measured value or its unit. Normalization and range flags are recalculated; an unrecognized unit keeps the value raw and unflagged.",
    resultUpdatedToast: "Result updated.",
  ...
  trendChart: {
    ...
    pointsHidden:
      "{{count}} point(s) hidden: measured in a unit that does not belong on this scale.",
