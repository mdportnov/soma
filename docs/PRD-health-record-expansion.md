...
- As a biohacker, I want to log symptoms with severity and overlay them on biomarker trends so I can see whether a drug changed how I _feel_, not just my labs.
