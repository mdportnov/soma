export const ru = {
  ...
  timeline: {
    ...
    layersTitle: "Слои",
    shiftHint: "Подсвеченные точки анализов — панели, где биомаркер сильно изменился по сравнению с предыдущей.",
  ...
  insights: {
    ...
    baseline: "Это первые значения по этим биомаркерам — будущие импорты будут сравниваться с ними.",
